...
{
    /// <summary>
    /// Web API Controller for Clubs entity defined in TrackrModels.ClubManagement data model
    /// </summary>
    public partial class ClubsController : OpenAccessBaseApiController<TrackrModels.Club, TrackrModels.ClubManagement>
    {
        /// <summary>
        ...
        public ClubsController(IOpenAccessBaseRepository<TrackrModels.Club , TrackrModels.ClubManagement> repository)
        {
        ...
        public virtual TrackrModels.Club Get(Int32 id)
        {
            TrackrModels.Club entity = repository.GetBy(t => t.ClubID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, TrackrModels.Club entity)
        {
                        if (entity == null ||
                id != entity.ClubID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.Club entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.Club>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.ClubID });

...
{
    /// <summary>
    /// Web API Controller for TransactionTypes entity defined in TrackrModels.ClubManagement data model
    /// </summary>
    public partial class TransactionTypesController : OpenAccessBaseApiController<TrackrModels.TransactionType, TrackrModels.ClubManagement>
    {
        /// <summary>
        ...
        public TransactionTypesController(IOpenAccessBaseRepository<TrackrModels.TransactionType , TrackrModels.ClubManagement> repository)
        {
        ...
        public virtual TrackrModels.TransactionType Get(Int32 id)
        {
            TrackrModels.TransactionType entity = repository.GetBy(t => t.TransactionTypeID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, TrackrModels.TransactionType entity)
        {
                        if (entity == null ||
                id != entity.TransactionTypeID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.TransactionType entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.TransactionType>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.TransactionTypeID });

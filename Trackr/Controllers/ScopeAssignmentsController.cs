...
{
    /// <summary>
    /// Web API Controller for ScopeAssignments entity defined in TrackrModels.UserManagement data model
    /// </summary>
    public partial class ScopeAssignmentsController : OpenAccessBaseApiController<TrackrModels.ScopeAssignment, TrackrModels.UserManagement>
    {
        ...
        /// </summary>
        public ScopeAssignmentsController()
        {
            this.repository = new ScopeAssignmentRepository();
        }
        ...
        public ScopeAssignmentsController(IOpenAccessBaseRepository<TrackrModels.ScopeAssignment , TrackrModels.UserManagement> repository)
        {
        ...
        public virtual TrackrModels.ScopeAssignment Get(Int32 id)
        {
            TrackrModels.ScopeAssignment entity = repository.GetBy(t => t.ScopeAssignmentID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, TrackrModels.ScopeAssignment entity)
        {
                        if (entity == null ||
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.ScopeAssignment entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.ScopeAssignment>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.ScopeAssignmentID });

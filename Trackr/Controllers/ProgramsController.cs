...
{
    /// <summary>
    /// Web API Controller for Programs entity defined in TrackrModels.ClubManagement data model
    /// </summary>
    public partial class ProgramsController : OpenAccessBaseApiController<TrackrModels.Program, TrackrModels.ClubManagement>
    {
        /// <summary>
        ...
        public ProgramsController(IOpenAccessBaseRepository<TrackrModels.Program , TrackrModels.ClubManagement> repository)
        {
        ...
        public virtual TrackrModels.Program Get(Int32 id)
        {
            TrackrModels.Program entity = repository.GetBy(t => t.ProgramID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, TrackrModels.Program entity)
        {
                        if (entity == null ||
                id != entity.ProgramID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.Program entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.Program>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.ProgramID });

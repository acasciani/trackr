...
{
    /// <summary>
    /// Web API Controller for Scopes entity defined in TrackrModels.UserManagement data model
    /// </summary>
    public partial class ScopesController : OpenAccessBaseApiController<TrackrModels.Scope, TrackrModels.UserManagement>
    {
        /// <summary>
        ...
        public ScopesController(IOpenAccessBaseRepository<TrackrModels.Scope , TrackrModels.UserManagement> repository)
        {
        ...
        public virtual TrackrModels.Scope Get(Int32 id)
        {
            TrackrModels.Scope entity = repository.GetBy(t => t.ScopeID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, TrackrModels.Scope entity)
        {
                        if (entity == null ||
                id != entity.ScopeID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.Scope entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.Scope>(httpStatusCode, entityToEmbed);

...
{
    /// <summary>
    /// Web API Controller for PlayerPasses entity defined in TrackrModels.ClubManagement data model
    /// </summary>
    public partial class PlayerPassesController : OpenAccessBaseApiController<TrackrModels.PlayerPass, TrackrModels.ClubManagement>
    {
        /// <summary>
        /// Constructor used by the Web API infrastructure.
        /// </summary>
        public PlayerPassesController()
        {
            this.repository = new PlayerPassRepository();
        }
        ...
        public PlayerPassesController(IOpenAccessBaseRepository<TrackrModels.PlayerPass , TrackrModels.ClubManagement> repository)
        {
        ...
        public virtual TrackrModels.PlayerPass Get(Int32 id)
        {
            TrackrModels.PlayerPass entity = repository.GetBy(t => t.PlayerPassID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, TrackrModels.PlayerPass entity)
        {
                        if (entity == null ||
                id != entity.PlayerPassID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.PlayerPass entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.PlayerPass>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.PlayerPassID });

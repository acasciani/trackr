...
{
    /// <summary>
    /// Web API Controller for WebUserInfos entity defined in TrackrModels.ClubManagement data model
    /// </summary>
    public partial class WebUserInfosController : OpenAccessBaseApiController<TrackrModels.WebUserInfo, TrackrModels.ClubManagement>
    {
        /// <summary>
        /// Constructor used by the Web API infrastructure.
        /// </summary>
        public WebUserInfosController()
        {
            this.repository = new WebUserInfoRepository();
        }
        ...
        public WebUserInfosController(IOpenAccessBaseRepository<TrackrModels.WebUserInfo , TrackrModels.ClubManagement> repository)
        {
        ...
        public virtual TrackrModels.WebUserInfo Get(Int32 id)
        {
            TrackrModels.WebUserInfo entity = repository.GetBy(t => t.UserID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, TrackrModels.WebUserInfo entity)
        {
                        if (entity == null ||
                id != entity.UserID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.WebUserInfo entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.WebUserInfo>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.UserID });

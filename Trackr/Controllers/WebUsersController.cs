...
{
    /// <summary>
    /// Web API Controller for WebUsers entity defined in TrackrModels.UserManagement data model
    /// </summary>
    public partial class WebUsersController : OpenAccessBaseApiController<TrackrModels.WebUser, TrackrModels.UserManagement>
    {
        /// <summary>
        ...
        public WebUsersController(IOpenAccessBaseRepository<TrackrModels.WebUser , TrackrModels.UserManagement> repository)
        {
        ...
        public virtual TrackrModels.WebUser Get(Int32 id)
        {
            TrackrModels.WebUser entity = repository.GetBy(t => t.UserID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, TrackrModels.WebUser entity)
        {
                        if (entity == null ||
                id != entity.UserID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.WebUser entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.WebUser>(httpStatusCode, entityToEmbed);

...
{
    /// <summary>
    /// Web API Controller for Permissions entity defined in TrackrModels.UserManagement data model
    /// </summary>
    public partial class PermissionsController : OpenAccessBaseApiController<TrackrModels.Permission, TrackrModels.UserManagement>
    {
        /// <summary>
        ...
        public PermissionsController(IOpenAccessBaseRepository<TrackrModels.Permission , TrackrModels.UserManagement> repository)
        {
        ...
        public virtual TrackrModels.Permission Get(Int32 id)
        {
            TrackrModels.Permission entity = repository.GetBy(t => t.PermissionID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, TrackrModels.Permission entity)
        {
                        if (entity == null ||
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.Permission entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.Permission>(httpStatusCode, entityToEmbed);

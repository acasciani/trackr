...
{
    /// <summary>
    /// Web API Controller for TeamPlayers entity defined in TrackrModels.ClubManagement data model
    /// </summary>
    public partial class TeamPlayersController : OpenAccessBaseApiController<TrackrModels.TeamPlayer, TrackrModels.ClubManagement>
    {
        /// <summary>
        ...
        {
            this.repository = new TeamPlayerRepository();
        }
        ...
        public TeamPlayersController(IOpenAccessBaseRepository<TrackrModels.TeamPlayer , TrackrModels.ClubManagement> repository)
        {
        ...
        public virtual TrackrModels.TeamPlayer Get(Int32 id)
        {
            TrackrModels.TeamPlayer entity = repository.GetBy(t => t.TeamPlayerID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, TrackrModels.TeamPlayer entity)
        {
                        if (entity == null ||
                id != entity.TeamPlayerID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.TeamPlayer entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.TeamPlayer>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.TeamPlayerID });

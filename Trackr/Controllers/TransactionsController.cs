...
{
    /// <summary>
    /// Web API Controller for Transactions entity defined in TrackrModels.ClubManagement data model
    /// </summary>
    public partial class TransactionsController : OpenAccessBaseApiController<TrackrModels.Transaction, TrackrModels.ClubManagement>
    {
        /// <summary>
        ...
        public TransactionsController(IOpenAccessBaseRepository<TrackrModels.Transaction , TrackrModels.ClubManagement> repository)
        {
        ...
        public virtual TrackrModels.Transaction Get(Int64 id)
        {
            TrackrModels.Transaction entity = repository.GetBy(t => t.TransactionID == id);
        ...
        public virtual HttpResponseMessage Put(Int64 id, TrackrModels.Transaction entity)
        {
                        if (entity == null ||
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.Transaction entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.Transaction>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.TransactionID });

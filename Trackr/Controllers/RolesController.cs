...
{
    /// <summary>
    /// Web API Controller for Roles entity defined in TrackrModels.UserManagement data model
    /// </summary>
    public partial class RolesController : OpenAccessBaseApiController<TrackrModels.Role, TrackrModels.UserManagement>
    {
        /// <summary>
        ...
        public RolesController(IOpenAccessBaseRepository<TrackrModels.Role , TrackrModels.UserManagement> repository)
        {
        ...
        public virtual TrackrModels.Role Get(Int32 id)
        {
            TrackrModels.Role entity = repository.GetBy(t => t.RoleID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, TrackrModels.Role entity)
        {
                        if (entity == null ||
                id != entity.RoleID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.Role entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.Role>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.RoleID });

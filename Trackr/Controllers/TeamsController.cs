...
{
    /// <summary>
    /// Web API Controller for Teams entity defined in TrackrModels.ClubManagement data model
    /// </summary>
    public partial class TeamsController : OpenAccessBaseApiController<TrackrModels.Team, TrackrModels.ClubManagement>
    {
        ...
        public TeamsController(IOpenAccessBaseRepository<TrackrModels.Team , TrackrModels.ClubManagement> repository)
        {
        ...
        public virtual TrackrModels.Team Get(Int32 id)
        {
            TrackrModels.Team entity = repository.GetBy(t => t.TeamID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, TrackrModels.Team entity)
        {
                        if (entity == null ||
                id != entity.TeamID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.Team entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.Team>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.TeamID });

...
{
    /// <summary>
    /// Web API Controller for Players entity defined in TrackrModels.ClubManagement data model
    /// </summary>
    public partial class PlayersController : OpenAccessBaseApiController<TrackrModels.Player, TrackrModels.ClubManagement>
    {
        ...
        public PlayersController(IOpenAccessBaseRepository<TrackrModels.Player , TrackrModels.ClubManagement> repository)
        {
        ...
        public virtual TrackrModels.Player Get(Int32 id)
        {
            TrackrModels.Player entity = repository.GetBy(t => t.PlayerID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, TrackrModels.Player entity)
        {
                        if (entity == null ||
                id != entity.PlayerID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.Player entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.Player>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.PlayerID });
